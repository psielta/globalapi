...
{
    public abstract class GenericPagedV2<TEntity, TContext, TKey1, TKey2, TDto> : IQueryRepositoryMultiKey<TEntity, TKey1, TKey2, TDto>
        ...
        where TContext : DbContext
    {
        ...
        public GenericPagedV2(TContext injectedContext, IMapper mapper, ILogger<GenericPagedRepositoryMultiKey<TEntity, TContext, TKey1, TKey2, TDto>> logger)
        {
            db = injectedContext;
            this.mapper = mapper;
            this.logger = logger;
