...
public partial class GlobalErpFiscalBaseContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<NfceAberturaCaixa>(entity =>
        {
            ...
            entity.HasOne(d => d.IdUsuarioNavigation).WithMany(p => p.NfceAberturaCaixas)
                .HasPrincipalKey(p => p.Id)
                .HasForeignKey(d => d.IdUsuario)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("nfce_abertura_caixa_fk1");
        });
        ...
        modelBuilder.Entity<NfceFormaPgt>(entity =>
        {
            ...
            entity.HasOne(d => d.CdEmpresaNavigation).WithMany()
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("nfce_forma_pgt_fk1");

            entity.HasOne(d => d.IdSaidaNavigation).WithMany()
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("nfce_forma_pgt_fk");

            entity.HasOne(d => d.NrAberturaCaixaNavigation).WithMany().HasConstraintName("nfce_forma_pgt_fk2");
        });
        ...
        modelBuilder.Entity<NfceProdutoSaidum>(entity =>
        {
            ...
            entity.HasOne(d => d.CdPlanoNavigation).WithMany(p => p.NfceProdutoSaidumCdPlanoNavigations)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("nfce_produto_saida_fk2");

            entity.HasOne(d => d.CdPlanoSecundarioNavigation).WithMany(p => p.NfceProdutoSaidumCdPlanoSecundarioNavigations).HasConstraintName("nfce_produto_saida_fk3");

            entity.HasOne(d => d.IdSaidaNavigation).WithMany(p => p.NfceProdutoSaida).HasConstraintName("nfce_produto_saida_fk");

            entity.HasOne(d => d.ProdutoEstoque).WithMany(p => p.NfceProdutoSaida)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("nfce_produto_saida_fk4");
        });
        ...
        modelBuilder.Entity<NfceSaida>(entity =>
        {
            ...
            entity.Property(e => e.HrSaida).HasDefaultValueSql("(now())::time(0) without time zone");
            entity.Property(e => e.IdPontoVenda).HasDefaultValueSql("'-1'::integer");
            entity.Property(e => e.IsNfce).HasDefaultValue(false);
            ...
            entity.HasOne(d => d.CdEmpresaNavigation).WithMany(p => p.NfceSaida)
                .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            entity.HasOne(d => d.IdUsuarioNavigation).WithMany(p => p.NfceSaida)
                .HasPrincipalKey(p => p.Id)
                .HasForeignKey(d => d.IdUsuario)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("nfce_saidas_fk3");

            entity.HasOne(d => d.NrAberturaCaixaNavigation).WithMany(p => p.NfceSaida)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("nfce_saidas_fk2");
        });

        modelBuilder.Entity<NfceSangriaCaixa>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("nfce_sangria_caixa_pkey");

            entity.Property(e => e.Data).HasDefaultValueSql("('now'::text)::date");
            entity.Property(e => e.Hora).HasDefaultValueSql("('now'::text)::time with time zone");
            entity.Property(e => e.Tipo).HasDefaultValueSql("''::character varying");

            entity.HasOne(d => d.CdEmpresaNavigation).WithMany(p => p.NfceSangriaCaixas)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("nfce_sangria_caixa_fk");

            entity.HasOne(d => d.IdUsuarioNavigation).WithMany(p => p.NfceSangriaCaixas)
                .HasPrincipalKey(p => p.Id)
                .HasForeignKey(d => d.IdUsuario)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("nfce_sangria_caixa_fk2");

            entity.HasOne(d => d.NrAberturaCaixaNavigation).WithMany(p => p.NfceSangriaCaixas)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("nfce_sangria_caixa_fk1");
        });

        modelBuilder.Entity<NfceSuprimentoCaixa>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("nfce_suprimento_caixa_pkey");

            entity.Property(e => e.Data).HasDefaultValueSql("('now'::text)::date");
            entity.Property(e => e.Hora).HasDefaultValueSql("('now'::text)::time with time zone");
            entity.Property(e => e.Tipo).HasDefaultValueSql("''::character varying");

            entity.HasOne(d => d.CdEmpresaNavigation).WithMany(p => p.NfceSuprimentoCaixas)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("nfce_suprimento_caixa_fk");

            entity.HasOne(d => d.IdUsuarioNavigation).WithMany(p => p.NfceSuprimentoCaixas)
                .HasPrincipalKey(p => p.Id)
                .HasForeignKey(d => d.IdUsuario)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("nfce_suprimento_caixa_fk2");

            entity.HasOne(d => d.NrAberturaCaixaNavigation).WithMany(p => p.NfceSuprimentoCaixas)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("nfce_suprimento_caixa_fk1");
        });
