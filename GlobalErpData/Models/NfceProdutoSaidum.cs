...
public partial class NfceProdutoSaidum : IIdentifiable<long>
{
    [Key]
    [Column("id")]
    ...
    [JsonIgnore]
    [ForeignKey("CdPlano")]
    [InverseProperty("NfceProdutoSaidumCdPlanoNavigations")]
    public virtual PlanoEstoque CdPlanoNavigation { get; set; } = null!;

    [JsonIgnore]
    [ForeignKey("CdPlanoSecundario")]
    [InverseProperty("NfceProdutoSaidumCdPlanoSecundarioNavigations")]
    public virtual PlanoEstoque? CdPlanoSecundarioNavigation { get; set; }
