...
namespace GlobalAPINFe.Controllers
{
    ...
    {
        public NfceSaidaController(IQueryRepositoryMultiKey<NfceSaida, int, int, NfceSaidaDto> repo, ILogger<GlobalLib.GenericControllers.GenericPagedControllerMultiKey<NfceSaida, int, int, NfceSaidaDto>> logger) : base(repo, logger)
        {
        }
